...
This Terms of Service Agreeemnt (this "Agreement") is a legally binding contract between Tooltitude LLC, a Limited Liability Company organized under the laws of the State of Delaware ("Provider") and an individual end user ("You", "Your", "User"). It applies to the repository https://github.com/tooltitude/support-py (the "Site"). You agree that when you use the Site, you will do so subject to this Agreement. DO NOT ACCESS USE THE SITE IF YOU ARE UNWILLING OR UNABLE TO BE BOUND BY THIS AGREEMENT.
